...
class HEXColorTests: XCTestCase {
  ...
  func testEightDigitMin() {
    let (red, green, blue, alpha) = UIColor(hex8: 0x0000_0000).rgba()
    XCTAssertEqual(red, 0)
    XCTAssertEqual(green, 0)
    XCTAssertEqual(blue, 0)
    XCTAssertEqual(alpha, 0)
  ...
  func testEightDigitStep() {
    let (red, green, blue, alpha) = UIColor(hex8: 0x1234_5678).rgba()
    XCTAssertEqual(red, 0x12)
    XCTAssertEqual(green, 0x34)
    XCTAssertEqual(blue, 0x56)
  ...
  func testEightDigitMax() {
    let (red, green, blue, alpha) = UIColor(hex6: 0xFFFF_FFFF).rgba()
    XCTAssertEqual(red, 0xFF)
    XCTAssertEqual(green, 0xFF)
    XCTAssertEqual(blue, 0xFF)
    XCTAssertEqual(alpha, 0xFF)
  ...
  func testStringOutput() {
    let color = UIColor(
      red: CGFloat(0x22 / 255.0), green: CGFloat(0x44 / 255.0), blue: CGFloat(0x66 / 255.0),
      alpha: CGFloat(0x88 / 255.0))
  ...
  func testArgb2rgba() {
    if let _ = "2468".argb2rgba {
    } else {
      XCTAssertTrue(true)
    }
    if let _ = "22446688".argb2rgba {
    } else {
      XCTAssertTrue(true)
    }
    if let _ = "#468".argb2rgba {
    } else {
      XCTAssertTrue(true)
    }
